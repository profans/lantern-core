...
export default class Router {
   ...
   * @param  {object} routes  The routes for the application
   * @param  {object} config  Router configuration.
   * @return {Router}  The router service.
   */
  constructor (Vue, VueRouter, routes, config) {
    Vue.use(VueRouter)
    this.service = new VueRouter({ ...config, routes })
  }
